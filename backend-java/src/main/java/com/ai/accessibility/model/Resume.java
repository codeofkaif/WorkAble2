...
/**
 * Resume Model - Matches Node.js Resume schema exactly
 */
...
public class Resume {
    ...
    private String template = "modern"; // modern, classic, creative, minimal
    ...
    // Explicit getters/setters to avoid Lombok/annotation issues
